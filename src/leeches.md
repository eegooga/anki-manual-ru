...
«Пиявки» — это карточки, которые вы постоянно забываете. Поскольку им
требуется много повторений, они отнимают значительно больше времени,
чем другие карточки.

Anki помогает выявлять «пиявки». Каждый раз, когда карточка на этапе
...
как «пиявку» и приостанавливает карточку. Порог и поведение
...
предупреждать о «пиявке». Эти предупреждения происходят с шагом,
...
После обнаружения «пиявки» есть несколько способов с ней поступить.

## Редактирование

Самый эффективный способ работать с «пиявкой» — изменить способ
...
Некоторые «пиявки» появляются из-за «интерференции». Например,
